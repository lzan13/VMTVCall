...
import com.vmloft.develop.library.tools.tv.widget.VMCameraPreview;
import java.io.File;
...
public class VMVideoCallActivity extends VMCallActivity {
    ...
    @BindView(R.id.fab_reject_call) ImageButton rejectCallFab;
    @BindView(R.id.fab_end_call) ImageButton endCallFab;
    @BindView(R.id.fab_answer_call) ImageButton answerCallFab;
